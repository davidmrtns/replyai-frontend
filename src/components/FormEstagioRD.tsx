      ...
      const clientAtualizado = [
        {
          ...
          estagios: prevEmpresa.rdstationcrm_client[0].estagios.map((estagio) =>
            estagio.id === id ? { ...estagio, ...estagioAtualizado } : estagio,
          ),
        },
        ...prevEmpresa.rdstationcrm_client.slice(1),
      ];
  ...
  return (
    <Form>
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          type="text"
          placeholder="ID do estágio no RD Station CRM"
          value={dealStageId}
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          type="text"
          placeholder="ID do usuário do estágio"
          value={userId}
