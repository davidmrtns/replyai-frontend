...
function FormVoz({ voz, selecionar }) {
  ...
  const enviar = async () => {
    ...
    if (voz === '+') {
      ...
      var resposta = await apiFetch.editarVoz(
        empresa.slug,
        voz.id,
        nome,
        descricao,
    ...
    <Form>
          ...
          <div className="mb-3 d-flex align-items-center">
            {previewUrl ? (
              ...
              <p className="fst-italic opacity-75 mb-0">
                Essa voz não tem um áudio de preview ainda
              </p>
            )}
          </div>
        </>
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          value={carregandoVozElevenLabs ? '' : nome}
          disabled={carregandoVozElevenLabs}
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          value={carregandoVozElevenLabs ? '' : descricao}
          disabled={carregandoVozElevenLabs}
      ...
      <p className="fst-italic opacity-75">
        As configurações abaixo alteram o comportamento da voz gerada. Normalmente os valores
        padrões já são satisfatórios e não é necessário alterá-los.
      </p>
      <Form.Group className="mb-3">
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          type="number"
          placeholder="Boost de similaridade"
