      ...
      const clientAtualizado = [
        {
          ...
          departamentos: prevEmpresa.digisac_client[0].departamentos.map((departamento) =>
            departamento.id === id ? { ...departamento, ...departamentoAtualizado } : departamento,
          ),
        },
        ...prevEmpresa.digisac_client.slice(1),
      ]
    ...
    <Form>
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          As IAs usarão este atalho para transferir os clientes para o departamento.
        </p>
        <Form.Control
          type="text"
          placeholder="Atalho do departamento"
          value={atalho}
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control
          type="text"
          placeholder="Comentário de transferência (opcional)"
          value={comentario}
      ...
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          Se informado, as IAs transferirão o cliente para este usuário diretamente.
        </p>
        <AsyncSelect
          cacheOptions
          defaultOptions
      ...
      <Form.Group className="mb-3">
        ...
        />
        <p className="fst-italic opacity-75">
          Se ativado, os clientes que iniciarem o fluxo de confirmação de agendamento serão
          direcionados para este departamento até finalizarem o fluxo.
        </p>
      </Form.Group>
