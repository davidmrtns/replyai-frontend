    ...
    <Form>
      ...
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          Este fuso-horário será utilizado para armazenar a hora da última mensagem enviada pelo
          cliente dentro da janela de conversa, com o objetivo de disparar mensagens de retomada de
          conversa.
        </p>
      ...
      <Form.Group className="mb-3">
        <p className="fst-italic opacity-75">
          Se uma empresa for desativada, os assistentes de IA dela não responderão mais aos
          clientes, nenhum fluxo automatizado (cobrança, lembrete de pagamentos, confirmação de
          atendimentos) será disparado e nenhum usuário dessa empresa poderá fazer login na
          plataforma.
        </p>
        <Form.Check
          type="switch"
      ...
      <Form.Group className="mb-3">
        ...
        <InputGroup>
          <Form.Control
            type={exibirOpenAIKey ? 'text' : 'password'}
            placeholder="Chave de API da OpenAI"
            value={openaiApiKey}
      ...
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          Se uma chave da ElevenLabs não for fornecida, as IAs não poderão responder seus clientes
          em áudio.
        </p>
        <InputGroup>
          <Form.Control
            type={exibirElevenLabsKey ? 'text' : 'password'}
            placeholder="Chave de API da ElevenLabs (opcional)"
            value={elevenLabsApiKey}
            onChange={(e) => setElevenLabsApiKey(e.target.value)}
          />
          <Button
            variant="outline-primary"
            onClick={() => setExibirElevenLabsKey(!exibirElevenLabsKey)}
          >
