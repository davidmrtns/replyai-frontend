      ...
      <Container className="p-4">
        {(novoUsuario && usuarioLogado.admin) || !novoUsuario ? (
          <Card>
            <Card.Header>
              <h2>
                <FontAwesomeIcon icon={faUser} /> {novoUsuario ? 'Novo usuário' : nome}
              </h2>
            </Card.Header>
            <Card.Body>
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <p className="fst-italic opacity-75">
                    Adicionar uma empresa ao usuário irá restringí-lo de acessar outras empresas e
                    editar informações globais da ReplyAI, como os exemplos de prompt.
                  </p>
