    ...
    <>
      ...
      <Container className="p-4">
        ...
        <p className="fst-italic opacity-75">
          Adicione exemplos de prompt para cada propósito de assistente, para que os usuários
          consigam criar os prompts dos seus próprios assistentes.
        </p>
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Select
              ...
              onChange={(opcao) => setTipoSelecionado(opcao.target.value)}
            >
              <option value="">--</option>
