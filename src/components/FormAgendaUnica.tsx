    ...
    <Form>
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          Antes de cadastrar a agenda, verifique se ela foi compartilhada com você através do seu
          provedor de agenda (Google ou Outlook).
        </p>
        <Form.Control
          type="email"
          placeholder="Endereço de e-mail da agenda"
          value={endereco}
      ...
      <Form.Group className="mb-3">
        ...
        <p className="fst-italic opacity-75">
          As IAs utilizarão este atalho para escolher a agenda correta para inserir o agendamento.
        </p>
        <Form.Control
          type="text"
          placeholder="Atalho da agenda"
          value={atalho}
