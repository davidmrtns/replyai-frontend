class ApiFetch {
  ...
  async removerColaborador(slug, id) {
    ...
    try {
      resposta = await fetch(
        `${this.urlBase}/empresa/${slug}/informacoes_basicas/colaborador/${id}`,
        {
          method: 'delete',
          credentials: 'include',
          headers: {
  ...
  async removerEstagioRD(slug, id) {
    ...
    try {
      resposta = await fetch(
        `${this.urlBase}/empresa/${slug}/informacoes_crm/rdstation/estagio/${id}`,
        {
          method: 'delete',
          credentials: 'include',
          headers: {
  ...
  async removerClienteAsaas(slug, id) {
    ...
    try {
      resposta = await fetch(
        `${this.urlBase}/empresa/${slug}/informacoes_financeiras/asaas/${id}`,
        {
          method: 'delete',
          credentials: 'include',
          headers: {
  ...
  async listarServicosDigisac(slug, pagina, nome, id) {
    ...
    try {
      await fetch(
        `${this.urlBase}/digisac/${slug}/servicos?pagina=${pagina}&nome=${nome}&id=${id}`,
        {
          method: 'get',
          credentials: 'include',
          headers: {
  ...
  async listarUsuariosDigisac(slug, pagina, nome, id) {
    ...
    try {
      await fetch(
        `${this.urlBase}/digisac/${slug}/usuarios?pagina=${pagina}&nome=${nome}&id=${id}`,
        {
          method: 'get',
          credentials: 'include',
          headers: {
  ...
  async listarDepartamentosDigisac(slug, pagina, nome, id) {
    ...
    try {
      await fetch(
        `${this.urlBase}/digisac/${slug}/departamentos?pagina=${pagina}&nome=${nome}&id=${id}`,
        {
          method: 'get',
          credentials: 'include',
          headers: {
